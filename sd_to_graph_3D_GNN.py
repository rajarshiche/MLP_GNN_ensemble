...
# estimate the Shannon entropy for each SMILES string
...
def freq_bond_list(bond_list_input_mol):
    ...
    # dictionary values as frequency array
...
def obabel_to_networkx3d_graph(input_mol, mol, **kwargs):
    ...
    for atom, atom_rdkit in zip(input_mol, mol.GetAtoms()):
        ...
        atom_type = atom_symbol ### atom symbol goes to atom type
        ...
        # Estimating the partial or fractional Shannon for an atom type => the current node and add to the node feature
